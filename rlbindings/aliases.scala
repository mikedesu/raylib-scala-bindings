...
object AudioCallback: 
  ...
  inline def fromPtr(ptr: Ptr[Byte] | Ptr[?]): AudioCallback = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
...
object LoadFileDataCallback: 
  ...
  inline def fromPtr(ptr: Ptr[Byte] | Ptr[?]): LoadFileDataCallback = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
...
object LoadFileTextCallback: 
  ...
  inline def fromPtr(ptr: Ptr[Byte] | Ptr[?]): LoadFileTextCallback = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
...
object SaveFileDataCallback: 
  ...
  inline def fromPtr(ptr: Ptr[Byte] | Ptr[?]): SaveFileDataCallback = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
...
object SaveFileTextCallback: 
  ...
  inline def fromPtr(ptr: Ptr[Byte] | Ptr[?]): SaveFileTextCallback = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
...
object TraceLogCallback: 
  ...
  inline def fromPtr(ptr: Ptr[Byte] | Ptr[?]): TraceLogCallback = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])

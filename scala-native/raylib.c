...
void __sn_wrap_raylib_DrawEllipseLinesV(Vector2 *center, float radiusH, float radiusV, Color *color) {
 DrawEllipseLinesV(*center, radiusH, radiusV, *color);
};


void __sn_wrap_raylib_DrawEllipseV(Vector2 *center, float radiusH, float radiusV, Color *color) {
...
void __sn_wrap_raylib_DrawRectangleGradientEx(Rectangle *rec, Color *topLeft, Color *bottomLeft, Color *bottomRight, Color *topRight) {
...
void __sn_wrap_raylib_ImageDrawTriangleFan(Image * dst, const Vector2 * points, int pointCount, Color *color) {
...
void __sn_wrap_raylib_ImageDrawTriangleStrip(Image * dst, const Vector2 * points, int pointCount, Color *color) {
...
float __sn_wrap_raylib_Vector2CrossProduct(Vector2 *v1, Vector2 *v2) {
